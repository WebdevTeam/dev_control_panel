...
*/
class PhinxRollback extends AbstractTask
{
    /**
    ...
    * @var string
    */
    protected $description = 'Rollsback the last database migration for a website.';
...
Rocketeer::add('SkubaseTask\PhinxRollback');
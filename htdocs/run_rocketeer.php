...
$command = "osascript -e 'tell application \"iTerm2\" to activate' -e 'tell application \"System Events\" to tell process \"iTerm2\" to keystroke \"t\" using command down' -e 'tell application \"System Events\" to tell process \"iTerm2\" to keystroke \"bash {$path_rocketer_bash}\"' -e 'tell application \"System Events\" to tell process \"iTerm2\" to key code 52' ";
